...
public class VehicleElementMap {
	...
	protected WebElement righthanddriveno;
	...
	protected WebElement priceTable;
	protected WebElement selectsilver_price;
	protected WebElement selectgold_price;
	protected WebElement selectplatinum_price;
	protected WebElement selectultimate_price;
	protected WebElement pricesum;
	protected WebElement nextsendquote;
	
	//informações para serem enviadas
